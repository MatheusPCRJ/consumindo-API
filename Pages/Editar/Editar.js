...
const validacaoForms = yup.object().shape({
    ...
    preço: yup.string().required("O preço é obrigatório!").min(4, "O preço precisa ter menos de 6 caracteres!")
})
...
function Edit(){
    ...
    const addPost = data => axios.put(`https://json-server-inky-nine.vercel.app/tribal/${id}`, data)
    .then(() => {
